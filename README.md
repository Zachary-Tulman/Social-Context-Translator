...
The Social Context Translator (SCT) is a chat-based web app designed to guide users through and provide clarity about social situations they've experienced. SCT warmly provides relevant social context and suggestions for the future based on the user's social situation and context.

<table>
    <tr>
        <td><img src="assets/example1.png" width=400></td>
        <td><img src="assets/example2.png" width=400></td>
    </tr>
</table>
...
3. Ensure `.env` is set up properly following `.env.example` (look up python-dotenv if unsure)
